...
// Human-readable labels for action/flag codes (mirrors backend actionMap.js)
const ACTION_LABELS = {
...
function labelAction(code) {
  return ACTION_LABELS[code] || String(code).replace(/_/g, ' ');
}
              ...
              <div>
                ...
                <Stack gap={0}>
                  {doc.flags.reasons.map((rr, i) => (
                    <Text size="xs" key={i}>• {labelAction(rr)}</Text>
                  ))}
                </Stack>
              </div>
            )}
              ...
              <div>
                ...
                <Stack gap={0}>
                  {doc.alerts.actions.map((a, i) => (
                    <Text size="xs" key={i}>• {labelAction(a)}</Text>
                  ))}
                </Stack>
              </div>
            )}
