...
test('detects newly added not accepted carrier Scan Health Plan', () => {
...
test('detects Alignment Health as not accepted', () => {
...
test('applies new Cigna 95811 preauth rule', () => {
